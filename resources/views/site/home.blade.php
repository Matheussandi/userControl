      ...
      <div class="col-md-5 d-flex align-items-center py-3 px-4 p-md-0" >
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="row">
              ...
              <x-text-input id="email" class="block mt-1 w-full rounded p-2" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
          ...
          <div class="row mt-4">
              ...
              <x-text-input id="password" class="block mt-1 w-full rounded p-2"
                              type="password"
                              name="password"
          ...
          <div class="block mt-4">
              ...
              <a class="text-decoration-none underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 float-end" href="{{ route('password.request') }}">
                  {{ __('Esqueceu a senha?') }}
              </a>
          @endif
          </div>
